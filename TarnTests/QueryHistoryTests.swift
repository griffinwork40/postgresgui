...
struct QueryHistoryTests {
    ...
    func testQueryHistoryInitializationAndStorage() throws {
        ...
        let container = try TarnModelContainerFactory.makeModelContainer(isStoredInMemoryOnly: true)
    ...
    func migrationFromV1PreservesExistingSavedQueries() throws {
        ...
        do {
            let oldSchema = Schema(versionedSchema: TarnSchemaV1.self)
        ...
        let migratedContainer = try TarnModelContainerFactory.makeModelContainer(url: storeURL)
